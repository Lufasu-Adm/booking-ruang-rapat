...
@section('content')
<div class="container">
    <h2>Rekap Booking Berdasarkan Tanggal</h2>
    ...
    <form method="GET" action="{{ route('bookings.export-filter') }}">
        ...
        {{-- PERBAIKAN DI SINI: Tombol Kembali yang Dinamis --}}
        ...
        @else
            <a href="{{ route('dashboard') }}" style="text-decoration: none; padding: 0.5rem 1rem; background-color: #6c757d; color: white; border-radius: 5px; margin-left: 0.5rem; font-size: 14px;">Kembali ke Dashboard</a>
        @endif
        {{-- AKHIR PERBAIKAN --}}
    </form>
