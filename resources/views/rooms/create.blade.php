    ...
    <div class="page-wrapper" style="background-image: url('/assets/ai-generated-boat-picture.jpg');">
        ...
        <nav class="navbar">
            ...
            <div class="navbar-links">
                ...
                {{-- Link untuk kelola ruangan, aktif jika di halaman kelola, tambah, atau edit ruangan --}}
        ...
        <main class="main-content">
            <div class="form-card">
                ...
                <form method="POST" action="{{ route('rooms.store') }}">
                    ...
                    {{-- Form group untuk memilih divisi, hanya untuk 'super admin' --}}
                    <div class="form-group">
